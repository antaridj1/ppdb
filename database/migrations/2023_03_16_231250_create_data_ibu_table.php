...
class CreateDataIbuTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('data_ibu', function (Blueprint $table) {
            ...
            $table->set('penghasilan_ibu', ['< Rp 500.000', 'Rp 500.000 - Rp 999.999', 'Rp 1.000.000 - Rp 1.999.999', 'Rp 2.000.000 - Rp 4.999.999', 'Rp 5.000.000 - Rp 20.000.000', '> Rp 20.000.000', 'Tidak Berpenghasilan']);
