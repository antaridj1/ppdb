...
@section('content')  
    ...
    <div class="content">                
        <div class="card card-default">
            ...
            <div class="card-body">
                <form method="post" action="{{route('sekolah.profile.update')}}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control @error('kuota') is-invalid @enderror" name="kuota" id="kuota" value="{{ $sekolah->kuota }}" required>
                        @error('kuota')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
