    ...
    <div class="card card-default">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <a href="{{ asset('storage/'.$siswa->dataPribadi->file->file_kk) }}" target="_blank">Lihat file</a>
            </div>
            {{-- file akta --}}
            <div class="form-group">
                <label for="scan_akta">Scan Kartu Akta Kelahiran</label>
                <a href="{{ asset('storage/'.$siswa->dataPribadi->file->file_akta_kelahiran) }}" target="_blank">Lihat file</a>
            </div>
            {{-- file ktp ortu --}}
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <a href="{{ asset('storage/'.$siswa->dataPribadi->file->file_ijazah_tk) }}" target="_blank">Lihat file</a>
            </div>
        </div>
    </div>
