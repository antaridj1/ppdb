<div class="modal fade" id="exampleModal_{{$sekolah->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{route('admin.sekolah.destroy',$sekolah->id)}}">
                @method('delete')
                @csrf
